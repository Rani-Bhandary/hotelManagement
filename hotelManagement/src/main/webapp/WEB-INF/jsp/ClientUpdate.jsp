...
<!-- Heading -->
<h1 style="text-align:center;"><u>Client Updation</u></h1>
...
<form:form action="/client-save"  method="post"  modelAttribute="clientDetails">
	...
	<form:input type="hidden" path="accommodationId" />
			...
			<td><form:input type="text" class="form-control" path="clientNumber" disabled="true"/>
			</td>
		</tr>
		...
		<td>
			...
			<td><form:input type="text" class="form-control" path="clientName" disabled="true"/>
			</td>
		</tr>
		...
		<td>
			...
			<td><form:input type="text" class="form-control" path="clientAddress" disabled="true"/>
			</td>
		</tr>
		...
		<td>
			...
			<td><form:input type="tel" class="form-control" path="contactNo" disabled="true"/>
			</td>
		...
		<td>
			...
			<td><form:input type="text" class="form-control" path="gender" list="genderList" disabled="true"/>
		...
		<td>
			...
			<td><form:input type="text" class="form-control" path="hotelId" list="hotelList" disabled="true"/>
		...
		<td>
			...
			<td><form:input type="date" class="form-control" path="checkinDate" disabled="true"/>
			</td>
		</tr>
		...
		<td>
			...
			<td><form:input type="date" class="form-control" path="checkoutDate" disabled="true"/>
			</td>
		</tr>
		...
		<td>
			...
			<td><form:input type="text" class="form-control" path="accommodationId" list="accommodationList" disabled="true"/>
